...
#PBS -N vyper_268T
#PBS -o 'vyper_example_script_268T.v0.3.5.sh.output'
...
## Run-time on 1-core node (v0.3.3): 19 minutes
############################################################
...
##
## (1) Download the 1-lane files (10GB):
##  ftp://ftp.sra.ebi.ac.uk/vol1/ERA090/ERA090597/fastq/100921_I123_FC802J2ABXX_L7_HUMohgRGADBAAPE_1.clean.fq.gz
##  ftp://ftp.sra.ebi.ac.uk/vol1/ERA090/ERA090597/fastq/100921_I123_FC802J2ABXX_L7_HUMohgRGADBAAPE_2.clean.fq.gz
##  and rename to 268T_1.fa.gz, 268T_2.fa.gz
##  published by Sung et al, PMID: 22634754.
##  or download the already aligned sam/bam files from:
##  http://ikmbtmp.uni-kiel.de/pibase/vy-per/268T.tar.gz
##
...
# FASTQ sequences
c=/ifs/data/nfs_share/sukmb175/sequences/publication_testdata/vyper/268T2

# results
d=/ifs/data/nfs_share/sukmb175/projects/publication_testdata/vyper/268T2.v0.3.5
mkdir -p ${d}
...
plottitle='Liver cancer 268T (DNA)'
echo Plot title:
echo ${plottitle}
