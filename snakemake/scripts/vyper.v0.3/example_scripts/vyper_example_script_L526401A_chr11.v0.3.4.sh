...
#PBS -o 'vyper_example_script_L526401A_chr11.v0.3.4.sh.output'
...
# results
d=/ifs/data/nfs_share/sukmb175/projects/publication_testdata/vyper/virusseq_testdata_chr11.v0.3.4
mkdir -p ${d}
