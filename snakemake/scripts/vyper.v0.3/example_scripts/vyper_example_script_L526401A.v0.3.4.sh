...
#PBS -N vyper_L526401A
#PBS -o 'vyper_example_script_L526401A.v0.3.4.sh.output'
...
## Run-time on 1-core node (v0.3.3): 18 minutes
############################################################
...
##
## (1) Download the required liver cancer example data 
##  from the VirusSeq homepage (VirusSeq is NOT needed for
##  this Vy-PER example script, but if you don't know VirusSeq, 
##  why not try it too?):
...
##  http://ikmbtmp.uni-kiel.de/pibase/vy-per/L526401A.tar.gz
##
...
# FASTQ sequences
c=/ifs/data/nfs_share/sukmb175/sequences/publication_testdata/vyper/virusseq_testdata

# results
d=/ifs/data/nfs_share/sukmb175/projects/publication_testdata/vyper/virusseq_testdata.v0.3.4
mkdir -p ${d}
...
plottitle='Liver cancer L526401A (RNA)'
echo Plot title:
echo ${plottitle}
