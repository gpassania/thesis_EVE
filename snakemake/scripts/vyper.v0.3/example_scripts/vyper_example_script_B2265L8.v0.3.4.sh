...
#PBS -N vyper_B2265L8
#PBS -o 'vyper_example_script_B2265L8.v0.3.4.sh.output'
...
##
## (1) Patient data not publicly available 
##  This example is only for timings on comparable EMC Isilon
##
...
# FASTQ sequences
c=/ifs/data/nfs_share/sukmb175/sequences/publication_testdata/vyper/B2265L8

# results
d=/ifs/data/nfs_share/sukmb175/projects/publication_testdata/vyper/B2265L8.v0.3.4
mkdir -p ${d}
...
plottitle='Leukemia B2265L8 (DNA)'
echo Plot title:
echo ${plottitle}
