...
#PBS -N vyper_NA12878
#PBS -o '1_vyper_example_script_NA12878.v0.3.5.sh.output'
...
############################################################
## Example script, very small/fast: only 22k paired ends
## Run-time on 1-core: 2 mins
############################################################
...
##
## (1) FASTQ file not publicly available as it contains
## confidential patient sequences
##
...
# FASTQ sequences
c=/ifs/data/nfs_share/sukmb175/sequences/publication_testdata/vyper

# results
d=/ifs/data/nfs_share/sukmb175/projects/publication_testdata/vyper/NA12878.v0.3.5
mkdir -p ${d}
...
lib=NA12878V
fastq1=${c}/${lib}_1.fastq.gz
fastq2=${c}/${lib}_2.fastq.gz

readsize=49to101
center=ICMB_Kiel_Germany

# title of summary PDF
plottitle='NA12878V (DNA)'
echo Plot title:
echo ${plottitle}
