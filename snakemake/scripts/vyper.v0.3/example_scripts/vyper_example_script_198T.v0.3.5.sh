...
#PBS -N vyper_198T
#PBS -o 'vyper_example_script_198T.v0.3.5.sh.output'
...
## Run-time on 1-core node (v0.3.3): 17 minutes
############################################################
...
##  ftp://ftp.sra.ebi.ac.uk/vol1/ERA090/ERA090597/fastq/100920_I189_FC208BGABXX_L7_HUMohgRADDBAAPE_1.clean.fq.gz
##  ftp://ftp.sra.ebi.ac.uk/vol1/ERA090/ERA090597/fastq/100920_I189_FC208BGABXX_L7_HUMohgRADDBAAPE_2.clean.fq.gz
##  and rename to 198T_1.fa.gz, 198T_2.fa.gz
##  published by Sung et al, PMID: 22634754.
##  or download the already aligned sam/bam files from:
##  http://ikmbtmp.uni-kiel.de/pibase/vy-per/198T.tar.gz
##
...
# FASTQ sequences
c=/ifs/data/nfs_share/sukmb175/sequences/publication_testdata/vyper/198T2

# results
d=/ifs/data/nfs_share/sukmb175/projects/publication_testdata/vyper/198T2.v0.3.5
mkdir -p ${d}
...
plottitle='Liver cancer 198T (DNA)'
echo Plot title:
echo ${plottitle}
